...
import { Button, TextInput, useTheme, Checkbox  } from 'react-native-paper';
  ...
  <View style={{ flexDirection: 'row', alignItems: 'flex-start', justifyContent: "space-between" , gap: 10 }}>
      <View style={{width:width+10, height:height+10, padding:5, backgroundColor:colors.surfaceVariant, justifyContent: "center"}}>
        <UserName
          width={width}
          height={height}
          toNext={()=>{router.push('/example/login_avatar')}}
          setUsernameToServer={(userName:string) => {
            return {
              ok: responseOk,
              reason: responseAlreadyExist ? "already exist" : "other"
            }
          }}
        />
      </View>
